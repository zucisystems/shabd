...
public class NavigationDrawerFragment extends Fragment  {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View v = (ExpandableListView) inflater.inflate(R.layout.fragment_navigation_drawer, container, false);
		assert v != null;
	    ...
	    // add first title
	   // mainActions.add(new TitoloGruppo("Bad guys"));           // 0
	    mainActions.add(new Azione(getString(R.string.title_section1)));    // 1
	    mainActions.add(new Azione(getString(R.string.title_section2)));        // 2
	    mainActions.add(new Azione(getString(R.string.title_section3)));              // 3
	    // add second title
	   // mainActions.add(new TitoloGruppo("Bad guys"));                      // 4
	    mainActions.add(new Azione(getString(R.string.title_section4)));             // 5
	    ...
	    childActions.put(3, new ArrayList<String>());
	    ...
	    mDrawerListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
	        ...
	        public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
	            ...
	            if(list.size() > 0)
	            	...
	            	case 0:
	            	startActivity(new Intent(getContext(), WebViewHome.class));
	            	break;
	            	case 1:
	        		...
	        		case 3:
	        			...
	        			break;
	        		case 4:
	        			startActivity(new Intent(getContext(), WebViewCareers.class));
	        			break;
	        		case 5:
	        			startActivity(new Intent(getContext(), WebViewContactUs.class));
	        			break;
	        			default:
		...
		mDrawerListView.setAdapter(
				new ArrayAdapter<String>(getActionBar().getThemedContext(), android.R.layout.simple_list_item_1,
						android.R.id.text1, new String[] { getString(R.string.title_section1),
								getString(R.string.title_section2), getString(R.string.title_section3),getString(R.string.title_section4),getString(R.string.title_section5),getString(R.string.title_section6), }));
