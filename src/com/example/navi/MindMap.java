...
//      	  int no_of_modules=s.nextInt();
      	int no_of_modules=WordToNumeric.convertToNumeric(s1);
      	...
      	// add child to root node
      	  ...
      	  for(int i=0;i<no_of_modules;i++)
      		...
      		Thread.currentThread().sleep(2000);
          	speakWords("Enter the Module "+(i+1));
          	updateSeconds("Enter the Module "+(i+1));
          	 
          	
          	editor = sharedPref.edit();
          	 ed1 = sh1.edit();
             //put your value
          	 ed1.putString("voice","Enter the Module "+(i+1));
             editor.putString("userName", s1);
editor.commit();
ed1.commit();
      	   ...
      	   no_of_functions=WordToNumeric.convertToNumeric(s1);
      		  ...
      		  {
      			Thread.currentThread().sleep(2000);
              	speakWords("Enter the functionality");
              	updateSeconds("Enter the functionality");
              	 editor = sharedPref.edit();
              	 ed1 = sh1.edit();
              	 
                 //put your value
                 editor.putString("userName", s1);
                 ed1.putString("voice", "Enter the functionality");  
                 //commits your edits
                 editor.commit();
                 ed1.commit();
      	  ...
      	  // add child to the child node created above
                 ...
                 ed1.commit();
      		    ...
      		    System.out.println("Enter the number of pages of "+ function [j]+" :");
      		  synchronized (lock) {
      			isRunning = false;
                	startActivity(new Intent(getApplicationContext(), Activity2.class));
                    if (!isRunning) try {
      	...
      	//Mindblock for function[j] node
      			  ...
      			  {
      				Thread.currentThread().sleep(2000);
                  	speakWords("Enter the pages");
                  	updateSeconds("Enter the pages");
                  	 editor = sharedPref.edit();
                  	 ed1 = sh1.edit();
                     //put your value
                     editor.putString("userName", s1);
                    ed1.putString("voice","Enter the pages");
                     //commits your edits
                     editor.commit();
                     ed1.commit();
      		  ...
      		  // add child to the child node created above
                     ...
                     ed1.commit();
      			    ...
      			    System.out.println("Enter the number of fields of "+ page [k]+" :");
      			  synchronized (lock) {
      				isRunning = false;
                  	startActivity(new Intent(getApplicationContext(), Activity2.class));
                      if (!isRunning) try {
      			...
      			else
      			{
      				mw.write("<node CREATED=\"5818\" MODIFIED=\"5818\" TEXT=\""
      				  ...
      				  {
      					Thread.currentThread().sleep(2000);
                      	speakWords("Enter the fields");
                      	updateSeconds("Enter the fields");
                      	 editor = sharedPref.edit();
                         //put your value
                      	 ed1 = sh1.edit();
                         editor.putString("userName", s1);
                         ed1.putString("voice","Enter the fields");
                         //commits your edits
                         editor.commit();
                         ed1.commit();
      				 ...
      				 // field[l]=s.next();
      					...
      					Thread.currentThread().sleep(2000);
                      	speakWords("Enter the number of subfields of "+ field[l]);
                      	updateSeconds("Enter the number of subfields of "+ field[l]);
                      	 editor = sharedPref.edit();
                      	 ed1 = sh1.edit();
                         //put your value
                         editor.putString("userName", s1);
                         ed1.putString("voice","Enter the number of subfields of "+ field[l]);
                         //commits your edits
                         editor.commit();
                         ed1.commit();


      				  System.out.println("Enter the number of subfields of "+ field[l]+" :");
      				synchronized (lock) {
      					isRunning = false;
                      	startActivity(new Intent(getApplicationContext(), Activity2.class));
                          if (!isRunning) try {
      		...
      		else
      		{
      			mw.write("<node CREATED=\"5818\" MODIFIED=\"5818\" TEXT=\""
      				  ...
      				  {
      					Thread.currentThread().sleep(2000);
      	              	speakWords("Enter the subfields of "+field[l]);
      	              	updateSeconds("Enter the subfields of "+field[l]);
      	              	 editor = sharedPref.edit();
      	                 //put your value
      	              	 ed1 = sh1.edit();
      	              	 ed1.putString("voice", "Enter the subfields of "+field[l]);
      	                 editor.putString("userName", s1);
      				  ...
      				  System.out.println("Enter the subfields of "+field[l]);
      				synchronized (lock) {
      					isRunning = false;
                      	startActivity(new Intent(getApplicationContext(), Activity2.class));
                          if (!isRunning) try {
